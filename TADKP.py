...
def book():
    ...
    if verifikasi.get() == 0:
        ...
        while step == 1:
            ...
            hasil =  "Terima kasih " + stringnama.get() + " telah membeli mobil " + jenis + " dengan harga Rp" + harga +  " Selamat menikmati mobil anda! " 
            messagebox.showinfo("Miracle's Premium Cars Market", hasil)
            step =0
